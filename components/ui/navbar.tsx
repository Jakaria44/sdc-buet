          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item, index) => (
              <motion.a
                ...
                className="text-cyan-100 hover:text-cyan-400 transition-colors duration-200 relative group"
              >
                {item.name}
              ...
              <div className="py-4 space-y-2">
                {navItems.map((item) => (
                  <motion.a
                    ...
                    className="block px-4 py-2 text-cyan-100 hover:text-cyan-400 hover:bg-slate-800/50 rounded-lg transition-all duration-200"
                  >
                    {item.name}
                  </motion.a>
                ))}
